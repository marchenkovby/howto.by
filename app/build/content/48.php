          <article class="article main-content__article">
            <header class="article__header">
              ...
              <figure class="article__figure">
                <img class="article__image" src="/images/4801.jpg" alt="Проверка скорости интернета на ноутбуке">
              </figure>
            ...
            <div class="article__content">
              ...
              <ol class="article__steps">
                <li class="article__steps-item">
                  ...
                  <figure class="article__figure">
                    <img class="article__image" src="/images/4802.jpg" alt="Проводное соединение через сетевой кабель модема ZTE ZXHN F609 и ноутбука">
                  </figure>
                </li>
                <li class="article__steps-item">
                  ...
                  <figure class="article__figure">
                    <img class="article__image" src="/images/4803.png" alt="Окно браузера с кнопкой для начала проверки скорости">
                  </figure>
                </li>
                <li class="article__steps-item">
                  <h2 class="article__heading article__heading--level-2 article__heading--step">Проверьте скорость интернета</h2>
                  <figure class="article__figure">
                    <img class="article__image" src="/images/4804.png" alt="Результаты проверки скорости в браузере на сайте speedtest.net">
                  </figure>
